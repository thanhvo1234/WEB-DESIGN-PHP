...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>With passion in work, as well as dedication to customers. We always try to create the best Pizza for our customers. Most importantly, the kitchen is clean, with natural fruits and vegetables, along with the best ingredients for the product.</p>
      ...
      <div class="box">
         ...
         <p>In order to keep the pizza hot, we also care about the fastest and most careful delivery to our customers, so training and recruiting professional shippers is very suitable for our shop.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>With pizza order, it comes in many varieties and sizes for family or friends. Everyone can chat and share pizza slices with their friends.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box">
               ...
               <option value="paytm">Viettel pay</option>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            We work with honesty, determination and devotion to our clients. That's our store's criteria.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            We will support shipping within a radius of 35km, and on average, delivery depends on the distance and will take from 5 minutes to 30 minutes.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            You can order in bulk or have a special pizza custom made to your liking if you call the store first.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Depending on the type of pizza, it can be very high in calories or protein. And if you want there will be a vegetable pizza that will be very good and contains a lot of protein.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Absolutely not, it's baked without oil in the oven and has a little olive oil on it, which is totally healthy.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>our address</h3>
         <p>VietNam, Da Nang - 658 Ngo Quyen</p>
      </div>

      <div class="box">
         <i class="fas fa-clock"></i>
         <h3>opening hours</h3>
         <p>09:00am to 00:10pm</p>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>email address</h3>
         <p>thanhvnkbgcd201808@fpt.edu.vn</p>
         <p>meimoushu@gmail.com</p>
      </div>
<style>
   h1.fa-3x{
         display: block;
...
<h1 class="fa-3x">
  <i class="fab fa-facebook fa-flip"></i>
  <i class="fa-brands fa-youtube fa-flip"></i>
  <i class="fa-brands fa-instagram fa-flip" style="--fa-flip-x: 1; --fa-flip-y: 0;" ></i>
  <i class="fa-brands fa-twitter fa-flip" style="--fa-animation-duration: 3s;" ></i>
</h1>
   ...
   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>ASM 2 Web design</span> 
   </div>
